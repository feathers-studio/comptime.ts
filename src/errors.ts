...
export const COMPTIME_ERRORS_MESSAGES = {
	...
	[COMPTIME_ERRORS.CT_ERR_SYNTAX_CHECK]: "Syntax error in comptime eval block.",
	[COMPTIME_ERRORS.CT_ERR_ERASE_TYPES]: "Error occurred while erasing types.",
	[COMPTIME_ERRORS.CT_ERR_CREATE_FUNCTION]: "Error occurred while creating a function.",
...
export const getErr = (code: ComptimeError, context?: string) =>
	...
	box(
		[
			context,
			box(
				COMPTIME_ERRORS_MESSAGES[code] + "\nSee: https://comptime.js.org/errors#" + code,
				{},
				context ? false : true,
			),
		]
